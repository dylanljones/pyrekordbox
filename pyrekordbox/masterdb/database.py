...
from ..utils import deobfuscate, get_rekordbox_pid, warn_deprecated
from . import models
from .aux_files import MasterPlaylistXml
from .models import DjmdContent, DjmdPlaylist, DjmdSongPlaylist, FileType, PlaylistType
...
class MasterDatabase:
    ...
    See Also
    --------
    pyrekordbox.db6.models: Rekordbox v6 database table definitions
    ...
    def get_local_usn(self) -> int:
        ...
        Any changes made to the `Djmd...` models increments the local update count of
    ...
    def add_to_playlist(
        ...
        song: models.DjmdSongPlaylist = models.DjmdSongPlaylist.create(
            ID=id_,
            PlaylistID=str(pid),
            ContentID=str(cid),
            TrackNo=track_no,
    ...
    def _create_playlist(
        ...
        if parent is None:
            ...
            parent_id = "root"
        elif isinstance(parent, models.DjmdPlaylist):
    ...
    def move_playlist(
        ...
        >>> db = MasterDatabase()
        >>> playlists = db.get_playlist().order_by(models.DjmdPlaylist.Seq)
            ...
            if seqence > old_seq:
                ...
                query = (
                    ...
                    .filter(
                        ...
                        models.DjmdPlaylist.Seq <= seqence,
                    )
                    .order_by(models.DjmdPlaylist.Seq)
                )
                other_playlists = query.all()
    ...
    def add_album(
        ...
        uuid = str(uuid4())
        album: models.DjmdAlbum = models.DjmdAlbum.create(
            ID=id_,
            Name=name,
    ...
    def add_genre(self, name: str) -> models.DjmdGenre:
        ...
        id_ = self.generate_unused_id(models.DjmdGenre)
        uuid = str(uuid4())
        genre: models.DjmdGenre = models.DjmdGenre.create(ID=id_, Name=name, UUID=uuid)
        self.add(genre)
        self.flush()
        return genre

    def add_label(self, name: str) -> models.DjmdLabel:
        ...
        id_ = self.generate_unused_id(models.DjmdLabel)
        uuid = str(uuid4())
        label: models.DjmdLabel = models.DjmdLabel.create(ID=id_, Name=name, UUID=uuid)
        self.add(label)
        self.flush()
        return label
    ...
    def add_content(self, path: PathLike, **kwargs: Any) -> DjmdContent:
        ...
        **kwargs:
        ...
        id_ = self.generate_unused_id(models.DjmdContent)
        file_id = self.generate_unused_id(models.DjmdContent, id_field_name="rb_file_id")
        uuid = str(uuid4())
    ...
    def to_dict(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        -------
        dict
            A dictionary containing the database models as keys and the table data as
            a list of dicts.
        """
        data = dict()
    ...
    def copy_unlocked(self, output_file: PathLike) -> None:
        ...
        exclude_models = ("sqlite_master", "sqlite_sequence", "sqlite_temp_master")
        ...
        # drop all models in target database
        for table in reversed(dst_metadata.sorted_tables):
            if table.name not in exclude_models:
        ...
        # create all models in target database
